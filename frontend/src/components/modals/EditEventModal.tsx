...
const EditEventModal: React.FC<EditEventModalProps> = ({ isOpen, onClose, onSuccess, event }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // For now, we'll use the create endpoint since we don't have update
      // In a real app, you'd have an updateEvent method
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-md p-3">
            <p className="text-blue-700 text-sm">
              <strong>Note:</strong> Editing events will create a new event. The original event will remain.
            </p>
          </div>
